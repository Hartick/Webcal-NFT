        ...
        <div className="flex justify-center mt-11">
            ...
            <div className="flex-column w-1/2  bg-black-600 px-8 py-8 rounded-t-lg text-white text-justify">
               ...
               <label for="Title" className="block mb-10" >
                    ...
                    <p className="mb-6 w-2/3">Choose a Title for your special NFT </p>
                ...
                <label for="Description">
                    ...
                    <p className="mb-6 w-2/3">Describe your art. Make it unique and share your creation with all the Webcal NFT Community </p>
